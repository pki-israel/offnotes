...
- Quatro tipos de nota: texto simples, texto formatado, Markdown (com visualização) e **checklist**
- Checklist: cada item tem uma caixinha marcável, com barra de progresso, contador, marcar/desmarcar todos, limpar concluídos e reordenação
- Checklist também dentro de notas Markdown: itens escritos como `- [ ] item` viram caixinhas clicáveis na visualização, e marcar uma reescreve o `- [ ]` para `- [x]` no texto de origem
...
app.js        armazenamento, editores, checklist, compartilhamento, criptografia
